...
public class PanelUserRepository implements PanacheRepository<PanelUser> {
    ...
    public void save(PanelUser user) {
        persist(user);
    }
    ...
    public List<PanelUser> search(String value, Integer page, Integer pageSize) {
    ...
    public List<PanelUser> search(UserSearchDTO request) {
